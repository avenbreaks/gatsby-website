...
const WHY_CHOOSE_DATA = {
  blockTitle: {
    ...
    text: 'Secure Transaction Easily Builds And Solving With Community',
  },
  posts: [
    {
      icon: icon1,
      ...
      text:
        'We will add liquidity according to market capacity to stabilize prices according to target.',
    },
    {
      icon: icon2,
      title: 'Verified Multitools And Trust',
      text:
        'We build git edgeware carefully and securely for everyone verified transactions safe and no leakage of your data.',
    },
    {
      icon: icon3,
      title: 'Fastest Transaction',
      text:
        'Vertical scaling involves adding processing power and memory to each node, thus creating more powerful nodes..',
    },
    {
      icon: icon4,
      title: 'Secure Transaction',
      text:
        'Blockchain technology is secure as it is decentralised and distributed. There is no single point of failure, which makes it much harder to corrupt.',
    },
  ],
};
