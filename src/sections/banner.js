...
const BANNER_DATA = {
  title: 'Next level Multichain Edgeware with fast and easy building',
  text:
    'We helps new brands  manage top-performing blockchain smart contract programs, relationship management, web3 integration, block builder, automated campaign reporting, performance measurement, and competitive benchmarking.',
  button: {
    link: 'https://git-waitlist.vercel.app',
    label: 'Get Token',
  },
  videoBtn: {
    link: '#',
