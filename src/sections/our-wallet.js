...
const OUR_WALLET_DATA = {
  title: 'Git Wallet is built-in for the cryptocurrencies customers',
  text:
    'Git Wallets crypto wallet that can be utilized for purchasing, selling, transferring, as well as storing digital currency. It securely stores a wide range of digital assets in offline storage.',
  tagLine: '*Web Wallet Still Building',
  options: [
    {
      icon: icon1,
      label: 'Secure transfers with verified Sign Kit.',
    },
    {
      icon: icon2,
      label: 'Easily buy and sell within the wallet.',
    },
    {
      icon: icon3,
      label: 'Pay for Gas in Git ShockFi.',
    },
  ],
  buttons: [
    {
