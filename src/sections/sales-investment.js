...
const SALES_INVESTMENT_DATA = {
  title: 'Total Investment in our project transaction',
  text:
    'We earned the trust of investors to make this project grow and make it more convenient and easier to build projects with us.',
  button: {
    link: '#',
    label: 'Learn More',
  },
