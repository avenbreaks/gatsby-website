...
const ROAD_MAP_DATA = {
  blockTitle: {
    title: 'Meet the Roadmap GTFX',
    text: 'Time Management',
  },
  posts: [
    {
      date: '29 December 2020',
      title: 'Shaping idea and active development',
      text:
        'At the end of 2020 we have been active to development this project',
    },
    {
      date: '25 December 2021',
      title: 'Apply Market Exchange and create Smart Contracts',
      text:
        'We create Smart Contracts, submit Proposals to the Polkadot Network and create a Cross Quad Network. Codename : GitEdge Ware',
    },
    {
      date: '15 March 2022',
      title: 'Prepare To Launch',
      text:
        'We launched the Multichain tools Git Edgeware and this project vote process.',
    },
  ],
};
